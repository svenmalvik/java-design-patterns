...
include::C:/git/java-design-patterns/extension-objects/README.adoc[]
...
include::C:/git/java-design-patterns/marker/README.adoc[]
...
The intention of the Builder pattern is to find a solution to the telescoping constructor
 ...
 the final {Hero} object.
++++

include::C:/git/java-design-patterns/builder/README.adoc[]
...
include::C:/git/java-design-patterns/factory method/README.adoc[]
...
include::C:/git/java-design-patterns/prototype/README.adoc[]
...
Singleton pattern ensures that the class can have only one existing instance per Java classloader
 ...
 in {IvoryTower}. Eager initialization implies that the implementation is thread safe. If
 ...
 is found in {EnumIvoryTower}. At first glance the code looks short and simple. However, you
 ...
 {ThreadSafeLazyLoadedIvoryTower} since it doesn't synchronize the whole access method but
...
include::C:/git/java-design-patterns/singelton/README.adoc[]
...
include::C:/git/java-design-patterns/adapter/README.adoc[]
...
Composition over inheritance. The Bridge pattern can also be thought of as two layers of abstraction.
 ...
 {Enchantment} have their own class hierarchies. The interface of the implementations
...
The Composite pattern is a partitioning design pattern. The Composite pattern describes that a
 ...
 be treated through the same interface {LetterComposite}.
++++

include::C:/git/java-design-patterns/composite/README.adoc[]
...
include::C:/git/java-design-patterns/dao/README.adoc[]
...
include::C:/git/java-design-patterns/data-mapper/README.adoc[]
...
include::C:/git/java-design-patterns/decorator/README.adoc[]
...
The Facade design pattern is often used when a system is very complex or difficult to understand
 ...
 In this example the Facade is {DwarvenGoldmineFacade} and it provides a simpler interface
 to the goldmine subsystem.
++++

include::C:/git/java-design-patterns/facade/README.adoc[]
...
include::C:/git/java-design-patterns/flyweight/README.adoc[]
...
include::C:/git/java-design-patterns/proxy/README.adoc[]
...
include::C:/git/java-design-patterns/chain/README.adoc[]
...
include::C:/git/java-design-patterns/command/README.adoc[]
...
include::C:/git/java-design-patterns/interpreter/README.adoc[]
...
include::C:/git/java-design-patterns/iterator/README.adoc[]
...
include::C:/git/java-design-patterns/mediator/README.adoc[]
...
include::C:/git/java-design-patterns/memento/README.adoc[]
...
The Model-View-Presenter(MVP) architectural pattern, helps us achieve what is called
 ...
 {FileSelectorJFrame} is the GUI and the {FileSelectorPresenter} is responsible to
...
include::C:/git/java-design-patterns/com.iluwatar.model.view.presenter.app/README.adoc[]
...
include::C:/git/java-design-patterns/observer/README.adoc[]
...
include::C:/git/java-design-patterns/state/README.adoc[]
...
include::C:/git/java-design-patterns/strategy/README.adoc[]
...
Template Method defines a skeleton for an algorithm. The algorithm subclasses provide
 ...
 In this example {HalflingThief} contains {StealingMethod} that can be changed. First
 the thief hits with {HitAndRunMethod} and then with {SubtleMethod}.
++++

include::C:/git/java-design-patterns/template-method/README.adoc[]
...
Visitor pattern defines mechanism to apply operations on nodes in hierarchy. New operations can
 ...
 traversed by visitors. {SoldierVisitor} applies its operation on {Soldier}s,
 {SergeantVisitor} on {Sergeant}s and so on.
++++

include::C:/git/java-design-patterns/com.iluwatar.visitor.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.doublechecked.locking.app/README.adoc[]
...
include::C:/git/java-design-patterns/servant/README.adoc[]
...
include::C:/git/java-design-patterns/service-locator/README.adoc[]
...
include::C:/git/java-design-patterns/null-object/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.event.aggregator.app/README.adoc[]

== com.iluwatar.callback.LambdasApp
++++
This example generates the exact same output as {App} however the callback has been
 defined as a Lambdas expression.
++++

include::C:/git/java-design-patterns/com.iluwatar.callback.lambdasapp/README.adoc[]
...
include::C:/git/java-design-patterns/callback/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.execute.around.app/README.adoc[]
...
include::C:/git/java-design-patterns/property/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.intercepting.filter.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.producer.consumer.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.poison.pill.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.reader.writer.lock.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.lazy.loading.app/README.adoc[]
...
Service layer defines an application's boundary with a layer of services that establishes a set
 ...
 {MagicService}. The service is implemented with 3-layer architecture (entity, dao,
 service). For persistence the example uses in-memory H2 database which is populated on each
 application startup.
++++

include::C:/git/java-design-patterns/com.iluwatar.servicelayer.app.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.specification.app.app/README.adoc[]
...
Tolerant Reader is an integration pattern that helps creating robust communication systems. The
 ...
 In this example we use Java serialization to write representations of {RainbowFish} objects
 to file. {RainbowFish} is the initial version which we can easily read and write using
 {RainbowFishSerializer} methods. {RainbowFish} then evolves to {RainbowFishV2}
 ...
 break even though {RainbowFishV2} has new fields that are serialized.
++++

include::C:/git/java-design-patterns/tolerant-reader/README.adoc[]
...
Model-View-Controller is a pattern for implementing user interfaces. It divides the application
 ...
 nourishment. {GiantView} can display the giant with its current status.
 {GiantController} receives input affecting the model and delegates redrawing the giant to
 the view.
++++

include::C:/git/java-design-patterns/com.iluwatar.model.view.controller.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.flux.app.app/README.adoc[]
...
When a message with a parameter is sent to an object, the resultant behaviour is defined by the implementation of
 ...
 In this example we have hierarchy of objects {GameObject} that can collide to each other. Each object has its
...
include::C:/git/java-design-patterns/double-dispatch/README.adoc[]
...
Whereas Singleton design pattern introduces single globally accessible object the Multiton
 ...
 In this example {Nazgul} is the Multiton and we can ask single {Nazgul} from it using
 {NazgulName}. The {Nazgul}s are statically initialized and stored in concurrent hash
 map.
++++

include::C:/git/java-design-patterns/multiton/README.adoc[]
...
Resource Acquisition Is Initialization pattern was developed for exception safe resource
 ...
 In Java RAII is achieved with try-with-resources statement and interfaces {Closeable} and
 {AutoCloseable}. The try-with-resources statement ensures that each resource is closed at
 ...
 In this example, {SlidingDoor} implements {AutoCloseable} and {TreasureChest}
 implements {Closeable}. Running the example, we can observe that both resources are
 automatically closed.

 http://docs.oracle.com/javase/7/docs/technotes/guides/language/try-with-resources.html
++++

include::C:/git/java-design-patterns/com.iluwatar.resource.acquisition.is.initialization.app/README.adoc[]
...
Thread Pool pattern is where a number of threads are created to perform a number of tasks, which
 ...
 into a {Worker} object that implements {Runnable}. We create an
 {ExecutorService} with fixed number of threads (Thread Pool) and use them to execute the
 {Worker}s.
++++

include::C:/git/java-design-patterns/thread-pool/README.adoc[]
...
include::C:/git/java-design-patterns/twin/README.adoc[]
...
The Private Class Data design pattern seeks to reduce exposure of attributes by limiting their
 ...
 In the example we have normal {Stew} class with some ingredients given in constructor. Then
 we have methods to enumerate the ingredients and to taste the stew. The method for tasting the
 stew alters the private members of the {Stew} class.
...
include::C:/git/java-design-patterns/private-class-data/README.adoc[]
...
When it is necessary to work with a large number of objects that are particularly expensive to
 ...
 {Oliphaunt}s can be checked out from the pool and later returned to it. The pool tracks
 created instances and their status (available, inUse).
++++

include::C:/git/java-design-patterns/com.iluwatar.object.pool.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.dependency.injection.app/README.adoc[]
...
The Front Controller is a presentation tier pattern. Essentially it defines a controller that
 ...
 {FrontController}. This object can carry out the common the behavior such as
 ...
 are displayed by sending correct request to the {FrontController} object. For example, the
 {ArcherView} gets displayed when {FrontController} receives request "Archer". When
 the request is unknown, we display the error view {ErrorView}.
++++

include::C:/git/java-design-patterns/com.iluwatar.front.controller.app/README.adoc[]
...
include::C:/git/java-design-patterns/repository/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.async.method.invocation.app/README.adoc[]
...
The MonoState pattern ensures that all instances of the class will have the same state. This can
 ...
 In the following example, The {LoadBalancer} class represents the app's logic. It contains
 a series of Servers, which can handle requests of type {Request}. Two instances of
...
include::C:/git/java-design-patterns/monostate/README.adoc[]
...
include::C:/git/java-design-patterns/step-builder/README.adoc[]
...
include::C:/git/java-design-patterns/half-sync-half-async/README.adoc[]
...
include::C:/git/java-design-patterns/layers/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.message.channel.app/README.adoc[]
...
The Fluent Interface pattern is useful when you want to provide an easy readable, flowing API.
 ...
 {SimpleFluentIterable} evaluates eagerly and would be too costly for real world
 applications. The {LazyFluentIterable} is evaluated on termination. Their usage is
 demonstrated with a simple number list that is filtered, transformed and collected. The result is
 printed afterwards.
++++

include::C:/git/java-design-patterns/com.iluwatar.fluentinterface.app.app/README.adoc[]
...
This application demonstrates Reactor pattern. The example demonstrated is a Distributed Logging
 ...
 <i>PARTICIPANTS</i> <br/>
 <ul>
 <li>Synchronous Event De-multiplexer</li> {NioReactor} plays the role of synchronous event
 de-multiplexer. It waits for events on multiple channels registered to it in an event loop.
 

 <li>Initiation Dispatcher</li> {NioReactor} plays this role as the application specific
 {ChannelHandler}s are registered to the reactor.
 

 <li>Handle</li> {AbstractNioChannel} acts as a handle that is registered to the reactor.
 When any events occur on a handle, reactor calls the appropriate handler.
 

 <li>Event Handler</li> {ChannelHandler} acts as an event handler, which is bound to a
...
include::C:/git/java-design-patterns/com.iluwatar.reactor.app.app/README.adoc[]
...
include::C:/git/java-design-patterns/caching/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.publish.subscribe.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.delegation.simple.app/README.adoc[]
...
An event-driven architecture (EDA) is a framework that orchestrates behavior around the
 ...
 example below uses an {EventDispatcher} to link/register {Event} objects to their
 respective handlers once an {Event} is dispatched, it's respective handler is invoked and
 the {Event} is handled accordingly.
++++

include::C:/git/java-design-patterns/event-driven-architecture/README.adoc[]
...
With the Microservices pattern, a client may need data from multiple different microservices.
 ...
 The {ApiGateway} makes calls to the Image and Price microservices using the
 {ImageClientImpl} and {PriceClientImpl} respectively. Customers viewing the site on a
 desktop device can see both price information and an image of a product, so the {ApiGateway}
 calls both of the microservices and aggregates the data in the {DesktopProduct} model.
 However, mobile users only see price information; they do not see a product image. For mobile
 users, the {ApiGateway} only retrieves price information, which it uses to populate the
 {MobileProduct}.
++++

include::C:/git/java-design-patterns/com.iluwatar.api.gateway.app/README.adoc[]
...
Factory-kit is a creational pattern which defines a factory of immutable content
 ...
 In the given example {WeaponFactory} represents the factory-kit, that contains
 four {Builder}s for creating new objects of
 the classes implementing {Weapon} interface.
 <br>Each of them can be called with {WeaponFactory#create(WeaponType)} method, with
 an input representing an instance of {WeaponType} that needs to
 be mapped explicitly with desired class type in the factory instance.
++++

include::C:/git/java-design-patterns/factory-kit/README.adoc[]
...
The Feature Toggle pattern allows for complete code executions to be turned on or off with ease. This allows features
 ...
 {UserGroup#isPaid(User)} then they get an ehanced version of the welcome message.
...
include::C:/git/java-design-patterns/feature-toggle/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.value.object.app/README.adoc[]
...
include::C:/git/java-design-patterns/module/README.adoc[]
...
The Monad pattern defines a monad structure, that enables chaining operations
 ...
 In the given example, the Monad pattern is represented as a {Validator} that takes an instance
 of a plain object with {Validator#of(Object)}
 and validates it {Validator#validate(Function, Predicate, String)} against given predicates.
 As a validation result {Validator#get()} it either returns valid object {Validator#t}
 or throws a list of exceptions {Validator#exceptions} collected during validation.
++++

include::C:/git/java-design-patterns/monad/README.adoc[]
...
include::C:/git/java-design-patterns/mute-idiom/README.adoc[]
...
include::C:/git/java-design-patterns/mutex/README.adoc[]
...
include::C:/git/java-design-patterns/semaphore/README.adoc[]
...
Hexagonal Architecture pattern decouples the application core from the
 ...
 {ConsoleAdministration} through which the lottery round is
 initiated and run and {ConsoleLottery} that allows players to
 submit lottery tickets for the draw.
 
 The secondary ports that application core uses are {WireTransfers}
 which is a banking service, {LotteryEventLog} that delivers
 eventlog as lottery events occur and {LotteryTicketRepository}
 that is the storage for the lottery tickets.
++++

include::C:/git/java-design-patterns/hexagonal/README.adoc[]
...
The Abstract Document pattern enables handling additional, non-static
 ...
 In Abstract Document pattern,{AbstractDocument} fully implements
 {Document} interface. Traits are then defined to enable access to
 properties in usual, static way.
++++

include::C:/git/java-design-patterns/abstract-document/README.adoc[]
...
include::C:/git/java-design-patterns/aggregator/README.adoc[]
...
include::C:/git/java-design-patterns/promise/README.adoc[]
...
include::C:/git/java-design-patterns/page-object/README.adoc[]
...
This application demonstrates the <b>Event-based Asynchronous</b> pattern. Essentially, users (of the pattern) may
 ...
 The {EventManager} manages the events/threads that the user creates. Currently, the supported event operations
...
include::C:/git/java-design-patterns/event-asynchronous/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.event.queue.app/README.adoc[]
...
Many solutions in the cloud involve running tasks that invoke services. In this environment, 
 ...
 In this example we have a class {MessageQueue} to hold the message {Message} objects. 
 All the worker threads {TaskGenerator} will submit the messages to the MessageQueue. 
 The service executor class {ServiceExecutor} will pick up one task at a time from the Queue and 
 execute them.
++++

include::C:/git/java-design-patterns/com.iluwatar.queue.load.leveling.app/README.adoc[]
...
The Data Bus pattern
 ...
 Similar to the {@code ObserverPattern}, members register themselves with the {DataBus}
 ...
 The {DataBus} class is a Singleton.</p>
 Members of the Data-Bus must implement the {Member} interface.</p>
 Data to be published via the Data-Bus must implement the {DataType} interface.</p>
 The {@code data} package contains example {DataType} implementations.</p>
 The {@code members} package contains example {Member} implementations.</p>
 The {StatusMember} demonstrates using the DataBus to publish a message
 to the Data-Bus when it receives a message.</p>
++++

include::C:/git/java-design-patterns/data-bus/README.adoc[]
...
include::C:/git/java-design-patterns/converter/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.guarded.suspension.app/README.adoc[]
...
include::C:/git/java-design-patterns/balking/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.cqrs.app.app/README.adoc[]
...
include::C:/git/java-design-patterns/com.iluwatar.event.sourcing.app.app/README.adoc[]
...
The Data Transfer Object pattern is a design pattern in which an data transfer object is used to serve related
 ...
 <p>
 In this example, ({CustomerClientApp}) as as customer details consumer i.e. client to request for
 customer details to server.
 <p>
 CustomerResource ({CustomerResource}) act as server to serve customer information.
 And The CustomerDto ({CustomerDto} is data transfer object to share customer information.
++++

include::C:/git/java-design-patterns/com.iluwatar.datatransfer.customerclientapp/README.adoc[]
...
Throttling pattern is a design pattern to throttle or limit the use of resources or even a complete service by
 ...
 {Tenant} is the Tenant POJO class with which many tenants can be created
 {B2BService} is the service which is consumed by the tenants and is throttled.
++++

include::C:/git/java-design-patterns/throttling/README.adoc[]

== Partial-Response
++++
The Partial response pattern is a design pattern in which client specifies fields to fetch to serve.
 Here {App} is playing as client for {VideoResource} server.
 Client ask for specific fields information in video to server.


 {VideoResource} act as server to serve video information.
++++

include::C:/git/java-design-patterns/partial-response/README.adoc[]
...
include::C:/git/java-design-patterns/wiretap/README.adoc[]
...
include::C:/git/java-design-patterns/eip-splitter/README.adoc[]
